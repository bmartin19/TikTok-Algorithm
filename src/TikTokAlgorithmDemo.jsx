...
export default function TikTokAlgorithmDemo() {
  ...
  const contentCategories = [
    ...
    {
      id: "inspirational",
      label: "Inspiritational Content",
      description: "Inspirital content/hopecore",
      mentalHealthImpact: +3,
      engagementLevel: 0.7,
      color: "bg-green-500"
    },
    ...
    // Negative Content Categories (RED)
    {
      ...
      description: "Fitness and body transformation content with unrealistic standards",
      mentalHealthImpact: -4,
    ...
    {
      id: "prejudice",
      label: "Discrimination and Prejudice",
      description: "Hateful content that promotes discrimination or prejudice ",
      mentalHealthImpact: -3,
      engagementLevel: 0.80,
      color: "bg-red-500"
    },
    ...
    },
    {
      ...
      description: "Misinformation content that can lead users in the wrong path",
      mentalHealthImpact: -2,
      engagementLevel: 0.9,
      color: "bg-red-500"
    },
    {
      ...
      description: " Use of drugs or alcohol as coping mechanisms, increasing the risk of addiction and mental health issues",
      mentalHealthImpact: -3,
      engagementLevel: 0.8,
      color: "bg-red-500"
    },
    {
      ...
      description: "Chronic work-related stress",
      mentalHealthImpact: -3,
      engagementLevel: 0.7,
      color: "bg-red-500"
    },
